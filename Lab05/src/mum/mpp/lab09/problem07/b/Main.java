...
public class Main {
	...
	public static void main(String[] args) {
		List<Employee> list = Arrays.asList(new Employee("Joe", "Davis", 120000),
                ...
                List<String> filtered = filteredEmployees.apply(list);
   ...
   public static final Function<List<Employee>,List<String>> filteredEmployees= 
            (list)->
            list.stream().filter(l->l.getSalary() > 100000)
